    ...
    @if (Session::has('error'))
        ...
        <div class="rounded-md mt-5 bg-red-50 p-4">
            <div class="flex">
              ...
              <div class="ml-3">
                <h3 class="text-sm font-medium text-red-800">We regret to inform you that the service is currently unavailable. We apologize for any inconvenience caused.</h3>
              </div>
            </div>
        </div>
    @endif
